      ...
      await axios
        .delete(
          `${import.meta.env.VITE_BACKEND_URL.replace(
            /\/$/,
            ""
          )}/task/deleteTask/${selectedTask._id}`,
          {
            headers: {
              ...
              {isFilterOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-40 bg-zinc-900 border border-zinc-800 rounded-lg shadow-xl z-20 overflow-hidden">
                    {["All", "Pending", "In Progress", "Completed", "Hold"].map(
                      (f) => (
                        <button
                          key={f}
                          onClick={() => {
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <div
                      className={`px-2.5 py-1 rounded-full text-xs font-semibold border ${styles.badge}`}
                    >
